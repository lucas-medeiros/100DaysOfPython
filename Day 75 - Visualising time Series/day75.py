# -*- coding: utf-8 -*-
"""Day 75 - Visualising time Series.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1565IKJNlssrNbcA6c-bv0NqQz7s_qMdD
...
df_btc_price_filtered = df_btc_price.dropna()
df_btc_price_filtered.head()
...
df_btc_price_filtered.DATE = pd.to_datetime(df_btc_price_filtered.DATE)
...
df_btc_monthly = df_btc_price_filtered.set_index('DATE').resample('M').last().reset_index()
...
ax2 = ax1.twinx()  # creates aother axis that shares the same x-axis
...
# Experiment with the linestyle and markers
ax1.plot(df_unemployment_2020.MONTH, df_unemployment_2020.UNRATE, color='purple', linewidth=2, linestyle='--')
ax2.plot(df_unemployment_2020.MONTH, df_unemployment_2020.UE_BENEFITS_WEB_SEARCH, color='skyblue', linewidth=2)
